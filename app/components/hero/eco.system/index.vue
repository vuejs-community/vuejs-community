...
const steps: Step[] = [
  {
    ...
    label: 'systems',
    title: 'UI Library',
    body: 'Architect cohesive, accessible interfaces with composable primitives, expressive theming, and production-grade interaction patterns.',
  },
  {
    id: 'hooks',
    step: '02',
    ...
    title: 'Composables',
    body: 'Encapsulate sophisticated behavior into elegant, framework-aware primitives that keep state predictable and product logic effortlessly reusable.',
  },
  {
    id: 'modules',
    step: '03',
    ...
    title: 'Nuxt Modules',
    body: 'Integrate advanced capabilities at the framework level—from content and authentication to analytics—without compromising architectural clarity.',
  },
  {
    id: 'plugins',
    step: '04',
    ...
    title: 'Vite Plugins',
    body: 'Orchestrate a faster, more intelligent toolchain that transforms source code, elevates developer experience, and optimizes every release.',
  },
]
