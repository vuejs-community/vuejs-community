...
export default defineProjectMeta({
  name: '@kev1n-peters/vite-plugin-node-polyfills',
  ...
  source: {
    ...
    npm: '@kev1n-peters/vite-plugin-node-polyfills',
  },
  links: {
    github: 'https://github.com/davidmyersdev/vite-plugin-node-polyfills',
    npm: 'https://www.npmjs.com/package/@kev1n-peters/vite-plugin-node-polyfills',
