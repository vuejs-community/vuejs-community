...
export default defineProjectMeta({
  name: '@gaearon/rollup-plugin-closure-compiler-js',
  ...
  source: {
    ...
    npm: '@gaearon/rollup-plugin-closure-compiler-js',
  },
  links: {
    github: 'https://github.com/camelaissani/rollup-plugin-closure-compiler-js',
    npm: 'https://www.npmjs.com/package/@gaearon/rollup-plugin-closure-compiler-js',
