...
export default defineProjectMeta({
  name: '@stream-io/rollup-plugin-node-builtins',
  ...
  links: {
    ...
    npm: 'https://www.npmjs.com/package/@stream-io/rollup-plugin-node-builtins',
  ...
  source: {
    ...
    npm: '@stream-io/rollup-plugin-node-builtins',
  },
  stats: {
    stars: 0,
    downloads: {
