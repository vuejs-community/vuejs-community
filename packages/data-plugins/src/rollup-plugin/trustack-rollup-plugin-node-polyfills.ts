...
export default defineProjectMeta({
  name: '@trustack/rollup-plugin-node-polyfills',
  ...
  source: {
    ...
    npm: '@trustack/rollup-plugin-node-polyfills',
  },
  links: {
    github: 'https://github.com/ionic-team/rollup-plugin-node-polyfills',
    npm: 'https://www.npmjs.com/package/@trustack/rollup-plugin-node-polyfills',
