...
export default defineProjectMeta({
  name: '@warrenseymour/rollup-plugin-node-builtins',
  ...
  source: {
    ...
    npm: '@warrenseymour/rollup-plugin-node-builtins',
  },
  links: {
    github: 'https://github.com/calvinmetcalf/rollup-plugin-node-builtins',
    npm: 'https://www.npmjs.com/package/@warrenseymour/rollup-plugin-node-builtins',
