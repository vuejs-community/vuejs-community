...
export default defineProjectMeta({
  name: '@gongchuangji/rollup-plugin-node-builtins',
  ...
  source: {
    ...
    npm: '@gongchuangji/rollup-plugin-node-builtins',
  },
  links: {
    github: 'https://github.com/calvinmetcalf/rollup-plugin-node-builtins',
    npm: 'https://www.npmjs.com/package/@gongchuangji/rollup-plugin-node-builtins',
